...
class ExperienceModel(models.Model):
    user = models.ForeignKey(
        UserInformations, on_delete=models.CASCADE, null=True, blank=True
    )
...
class Job(models.Model):
    ...
    requirement = models.CharField(
        max_length=12, choices=Requirement.choices, default="python"
    )
    ...
    job_status = models.CharField(
        max_length=100, choices=JOB_STATUS_CHOICES, default="ACTIVE"
    )
